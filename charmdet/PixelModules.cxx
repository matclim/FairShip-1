...
{ 
  ...
  TGeoMedium *air = gGeoManager->GetMedium("air");
    ...
    Int_t PixelIDlist[nSi] = {111,112,121,122,131,132,141,142,151,152,161,162}; 
    //Alternated pixel stations optimized for y and x measurements
    Bool_t vertical[nSi] = {kTRUE,kTRUE,kFALSE,kFALSE,kTRUE,kTRUE,kFALSE,kFALSE,kTRUE,kTRUE,kFALSE,kFALSE}; 
